...
class QualsFdw(ForeignDataWrapper):
    """ 
    ...
    def __init__(self, fdw_options, fdw_columns):
        super(QualsFdw, self).__init__(fdw_options, fdw_columns)
    ...
    def execute(self, quals, columns, sortkeys = None):
                ...
                if quals:
                    ...
                    if x_bool and y_bool:
                        files_info[row['filename']] = [row['format'],
                                                       ...
                                                       min_y,
                                                       max_y,]
                # no search conditions given, all the files are relevant.
                else:
                   files_info[row['filename']] = [row['format'],
                                                       min_x,
                                                       max_x,
        ...
        # read the relevant files one by one
